function [ score, psi, loss ] = loss_par_mv_flandmark( options, NFfeatures, Yaws, GTs, tmp, psi_gt, models, featuresPool, flandmark_pool, W )
...
%             GT = data.GTs{i};
    ...
    to = options{GTphi}.to;
    score = maximum - W(from:to)'*flandmark_pool{GTphi}.getPsi(GTs);
